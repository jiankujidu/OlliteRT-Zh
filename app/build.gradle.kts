...
// China catalogue: bundled asset behind the built-in "cn_mirror" repository.
val syncAllowlistCn by tasks.registering(Copy::class) {
  from(rootProject.file("../../model_allowlists/v1/model_allowlist_cn.json"))
  into(layout.projectDirectory.dir("src/main/assets"))
}
tasks.named("preBuild") { dependsOn(syncAllowlistCn) }
